    ...
    public partial class updateuserid : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Portfolios", t => t.ProductId, cascadeDelete: true)
                .Index(t => t.ProductId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ProductGalleries", "ProductId", "dbo.Portfolios");
            DropForeignKey("dbo.ProductCategory", "CategoryId", "dbo.Categories");
            DropForeignKey("dbo.ProductCategory", "ProductId", "dbo.Portfolios");
